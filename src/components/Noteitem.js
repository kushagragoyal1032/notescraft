...
const context = useContext(NoteContext);
  const { note, updateNote } = props; // destructuring  coming from notes.js
  const { deleteNote, showAlert } = context; // destructuring   // here deleteNote is function in NoteState
